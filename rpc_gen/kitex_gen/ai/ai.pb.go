...
func (x *ToolReq) GetContent() string {
	if x != nil {
		return x.Content
	}
	return ""
...
func (x *ToolReq) GetUserId() uint32 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *ToolResp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ToolResp) ProtoMessage() {}

func (x *ToolResp) ProtoReflect() protoreflect.Message {
	mi := &file_ai_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ToolResp.ProtoReflect.Descriptor instead.
func (*ToolResp) Descriptor() ([]byte, []int) {
	return file_ai_proto_rawDescGZIP(), []int{1}
}

func (x *ToolResp) GetContent() string {
	if x != nil {
		return x.Content
	}
	return ""
...
var file_ai_proto_rawDesc = []byte{
	0x0a, 0x08, 0x61, 0x69, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x02, 0x61, 0x69, 0x22, 0x3c,
	0x0a, 0x07, 0x54, 0x6f, 0x6f, 0x6c, 0x52, 0x65, 0x71, 0x12, 0x18, 0x0a, 0x07, 0x63, 0x6f, 0x6e,
	...
	,
...
var file_ai_proto_goTypes = []interface{}{
	(*ToolReq)(nil),  // 0: ai.ToolReq
	(*ToolResp)(nil), // 1: ai.ToolResp
}
var file_ai_proto_depIdxs = []int32{
	0, // 0: ai.AiService.Tool:input_type -> ai.ToolReq
	1, // 1: ai.AiService.Tool:output_type -> ai.ToolResp
...
type AiService interface {
	Tool(ctx context.Context, req *ToolReq) (res *ToolResp, err error)
}
